...
CREATE TABLE "Recipe" (
    ...
    "categoryRecipeId" INTEGER NOT NULL,
...
-- AddForeignKey
ALTER TABLE "Recipe" ADD CONSTRAINT "Recipe_categoryRecipeId_fkey" FOREIGN KEY ("categoryRecipeId") REFERENCES "CategoryRecipe"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
